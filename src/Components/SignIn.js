        ...
        <div className="signIn">
            <div className="box">
                ...
                <form className="form form__register" action="">
                    ...
                    {/* Password */}
                    <div className="form__helper">
                        <input className="form__label" type="password" name="password" id="new-user-password"></input>
                        <label for="new-user-password">Password</label>
                    </div>
                    {/* Confirm Password */}
                    <div className="form__helper">
                        <input className="form__label" type="password" name="password" id="confirm-password"></input>
                    ...
                    <label className="form__link">Sign In!</label>
                </form>
                ...
                <form className="form form__register" action="">
                    ...
                    <label className="form__link">Sign Up!</label>
                </form>
